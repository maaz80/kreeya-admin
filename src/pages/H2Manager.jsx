// admin/components/H2Manager.jsx
import { useState, useEffect } from 'react';
import Breadcrumb from '../components/BreadCrumb';

const API_URL = import.meta.env.VITE_BACKEND_URL || 'http://localhost:5000/api';

export default function H2Manager() {
     ...
     const pages = ['home', 'landing-page', 'contact-us', 'you_may_like_component', 'menu_component', 'chatbot_component'];
     ...
     const fetchHeadingStructure = async () => {
          ...
          setFetchError('');
          try {
               const res = await fetch(`${API_URL}/h2/structure/${selectedPage}`);
               if (!res.ok) {
     ...
     const handleSave = async (headingId) => {
          ...
          try {
               const res = await fetch(`${API_URL}/h2/upsert`, {
                    method: 'POST',
                    headers: {
     ...
     const handleDelete = async (headingId) => {
          ...
          try {
               const res = await fetch(`${API_URL}/h2/${id}`, { method: 'DELETE' });
     ...
     return (
          <div className="">
               ...
               <div className='p-6 max-w-4xl mx-auto'>
                    <h1 className="text-2xl font-bold mb-6">H2 Tags Manager</h1>
